    ...
    <form action="create" method="post" enctype="multipart/form-data">
      ...
      <div class="create_seasoning_form">
        <div class="create_seasoning_name_area">
          ...
          @if ((($errors->has('dialog_name')) == "create_dialog" ) && ($errors->has('seasoning_name')))
            <div class="seasoning_name_label_error">調味料名</div></label>
          ...
          @else
            <div class="seasoning_name_label">調味料名</div></label>
        ...
        <div class="create_seasoning_inventory_area">
          ...
          @if ((($errors->has('dialog_name')) == "create_dialog" ) && ($errors->has('seasoning_inventory')))
            <div class="seasoning_inventory_label_error">在庫数</div></label>
          ...
          @else
            <div class="seasoning_inventory_label">在庫数</div></label>
        ...
        <div class="create_seasoning_remarks_area">
          ...
          @if ((($errors->has('dialog_name')) == "create_dialog" ) && ($errors->has('remarks')))
            <div class="remarks_label_error">メモ</div></label>
          ...
          @else
            <div class="remarks_label">メモ</div></label>
        ...
        <div class="create_seasoning_image_area">
          <label for="create_seasoning_image">
            ...
            <input type="file" name="seasoning_image" class="create_seasoning_image" id="create_seasoning_image" accept=".jpg,.jpeg,.png" onchange="imagePreview(event)">
          </label>
          @if ((($errors->has('dialog_name')) == "create_dialog" ) && ($errors->has('seasoning_image')))
            <div class="error_message">{{ $errors->first('seasoning_image') }}</div>
          @endif
        </div>
        <div class="preview_annotation">画像プレビュー</div>
        <div class="image_area">
          <div class="img_preview" id="img_preview"></div>
        </div>
        <div class="form_btn">
